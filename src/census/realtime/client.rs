...
impl RealtimeClient {
    ...
    pub fn connect(&mut self) -> Result<Receiver<Event>, AuraxisError> {
    ...
    fn resubscribe(self, ws_send: Sender<Message>) -> Result<(), AuraxisError> {
        loop {
            let res = ws_send
    ...
    fn ping_ws(ping_send: Sender<Message>) -> Result<(), AuraxisError> {
